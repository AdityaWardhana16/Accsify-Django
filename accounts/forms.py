...
class SignUpForm(UserCreationForm):
    ...
    def save(self, commit=True):
        ...
        user.birth_date = self.cleaned_data.get("birthdate")
...
class ProfileUpdateForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'first_name': forms.TextInput(attrs={'placeholder': 'Masukkan First Name', 'class': 'form-control'}),
            'last_name': forms.TextInput(attrs={'placeholder': 'Masukkan Last Name', 'class': 'form-control'}),
            'email': forms.EmailInput(attrs={'placeholder': 'Masukkan Email', 'class': 'form-control'}),
            'phone_number': forms.TextInput(attrs={'placeholder': 'Masukkan Nomor Telepon', 'class': 'form-control'}),
        }
